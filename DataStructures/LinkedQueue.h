/*-- LinkedQueue.h -------------------------------------------------------------
 ...
 This header file defines a LinkedQueue data type.
 Basic operations:
...
public:
    ...
    /*-----------------------------------------------------------------------
     ...
     /***** Assignment *****/
    const LinkedQueue& operator= (const LinkedQueue& rightHandSide);
    /*-----------------------------------------------------------------------
     Assignment Operator
...
ostream& operator<< (ostream& out, const LinkedQueue& aList);
